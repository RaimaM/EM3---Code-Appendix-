...
TRIG_SOUND_TRAINING = {
    633: 40,   # zone 1 (farthest)  
    525: 41,   # zone 2             
    371: 42,   # zone 3      
    220: 43 ,  # zone 4  
     40: 44,   # zone 5 (nearest)  
}

TRIG_SOUND_TRANSITION = {
    633: 50,   # zone 1 (farthest)  
    525: 51,   # zone 2             
    371: 52,   # zone 3      
    220: 53 ,  # zone 4
     40: 54,   # zone 5 (nearest)  
}

TRIG_SOUND_TEST = {
    633: 60,   # zone 1 (farthest)  
    525: 61,   # zone 2             
    371: 62,   # zone 3      
    220: 63 ,  # zone 4
     40: 64,   # zone 5 (nearest)  
}
...
# -----------------------------
design = [
    {"block": 1, "phase": "training", "condition": "AS+PS", "sound": True, "ntrials": 50},
    {"block": 1, "phase": "transition", "condition": "AS+PS", "sound": True, "ntrials": 40},
    {"block": 1, "phase": "test",     "condition": "AS",    "sound": True, "ntrials": 30},

    {"block": 2, "phase": "training", "condition": "AS+PS", "sound": True, "ntrials": 20},
    {"block": 2, "phase": "transition", "condition": "AS+PS", "sound": True, "ntrials": 20},
    {"block": 2, "phase": "test",     "condition": "PS",    "sound": False, "ntrials": 30},

    {"block": 5, "phase": "training", "condition": "AS+PS", "sound": True, "ntrials": 20},
    {"block": 5, "phase": "transition", "condition": "AS+PS", "sound": True, "ntrials": 20},
    {"block": 5, "phase": "test",     "condition": "MIX",   "sound": None, "ntrials": 30},
]
...
# sound triggers
sound_triggers = [
    (633, 'short_sounds/woodbird.wav', 0.6),
    (525, 'short_sounds/coaster.wav', 0.4),
    (371, 'short_sounds/cup.wav', 0.15),
    (220, 'short_sounds/kitchen_roll.wav', 0.2),
    (40, 'short_sounds/real_t.wav', 1),
]
